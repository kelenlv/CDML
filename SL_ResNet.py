...
#===================================================================  
program = "SL ResNet18 on noniid CIFAR10"
...
# flops, params = profile(net_glob_client, inputs=(input, ))
...
net_glob_server = ResNet18_server_side(Baseblock, [2,2,2], cc) #7 is my numbr of classes
if torch.cuda.device_count() > 1:
    print("We use",torch.cuda.device_count(), "GPUs")
...
def train_server(fx_client, y, l_epoch_count, l_epoch, idx, len_batch):
    ...
    # flops, params = profile(net_glob_server, inputs=(fx_client, ))#modofied by lkx
    # flops, params = clever_format([flops, params], "%.3f")
    ...
    # print(fx_client.size())#torch.Size([128, 64, 9, 9])
    # print(fx_client.dtype)#torch.float32
    y = y.to(device)
    ...
    # print(dfx_client.size())#torch.Size([128, 64, 9, 9])
    # print(dfx_client.dtype)#torch.float32
...
for iter in range(epochs):
    ...
    for idx in idxs_users:
        ...
        net_glob_client.load_state_dict(w_client,strict=False)
