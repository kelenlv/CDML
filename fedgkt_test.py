...
from resnet56_gkt.resnet_client import resnet8_56
from resnet56_gkt.resnet_server import resnet56_server
...
#modified by lkx
noniid =False #True
dataset_train, dataset_test, dict_users, dict_users_test = load_cifar100(num_users, noniid)#load_HAM10000
cc = 100 # 10
...
net_glob_server = resnet56_server(cc)
if torch.cuda.device_count() > 1:
    print("We use",torch.cuda.device_count(), "GPUs")
